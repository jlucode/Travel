...
function timeConvert(n) {
    ...
    function clickHandler(){
        ...
        const axiosPosts = async () => {
            try{
            const response3 = await axios(`https://engine.hotellook.com/api/v2/cache.json?location=bali&checkIn=${dateformatted}&checkOut=${dateformatted2}&currency=usd&limit=20&sortBy=priceFrom&token=1fb2829993009e6a7db3163d4d00a1ff`)
